...
class Mailer {
    protected $_ci;
    protected $email_pengirim = 'merrys.collection2019@gmail.com'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'Merrys Collection'; // Isikan dengan nama pengirim
    protected $password = 'merrys123'; // Isikan dengan password email pengirim
